...
class AppConstants {
  static const String otp =
      'https://project.artisans.qa/go-crispy/api/v1/auth/confirm-otp'; //by default1234 annu
  static const String registrationApi =
      'https://project.artisans.qa/go-crispy/api/v1/auth/registration';
  static const String phoneApi =
      'https://project.artisans.qa/go-crispy/api/v1/auth/sent-mobile-number';
