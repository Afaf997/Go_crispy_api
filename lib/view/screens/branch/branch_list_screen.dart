...
class BranchListScreen extends StatefulWidget {
  ...
  const BranchListScreen({Key? key, required this.useNavigator}) : super(key: key);
...
class _BranchListScreenState extends State<BranchListScreen> {
                                  ...
                                  Positioned.fill(
                                    child: Align(
                                      ...
                                      child: SingleChildScrollView(
                                        ...
                                        child: Row(
                                          children: _branchesValue.map((branchValue) {
  ...
  void _setBranch(bool useNavigator) {
    final branchProvider = Provider.of<BranchProvider>(context, listen: false);
    branchProvider.setBranch(branchProvider.selectedBranchId!);

    if (useNavigator) {
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => DashboardScreen(pageIndex: 0)));
    } else {
