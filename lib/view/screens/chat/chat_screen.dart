  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: ResponsiveHelper.isDesktop(context) ? const PreferredSize(preferredSize: Size.fromHeight(100), child: WebAppBar())
          ...
          : Text('${widget.orderModel!.deliveryMan!.fName!} ${widget.orderModel!.deliveryMan!.lName!}'),backgroundColor: ColorResources.kOrangeColor,
          actions: <Widget>[
            Padding(
                      ...
                      InkWell(
                        ...
                        child: Padding(
                          ...
                          child: Provider.of<ChatProvider>(context, listen: false).isLoading ? const SizedBox(
                            ...
                            color: Provider.of<ChatProvider>(context).isSendButtonActive ? ColorResources.kOrangeColor : Theme.of(context).hintColor,
                          ),
                        ),
                      ),
