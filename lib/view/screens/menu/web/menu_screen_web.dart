    ...
    final List<MenuModel> menuList = [
      ...
      if (splashProvider.policyModel != null &&
        ...
        MenuModel(
            ...
            route: () => RouterHelper.getReturnPolicyRoute()),
      if (splashProvider.policyModel != null &&
      ...
      MenuModel(
          ...
          route: () => RouterHelper.getAboutUsRoute()),
      MenuModel(
        icon: Images.version,
        title:
            "${getTranslated('version', context)} ${Provider.of<SplashProvider>(context, listen: false).configModel!.softwareVersion ?? AppConstants.appVersion}",
        route: () {},
      ),
      MenuModel(
        icon: Images.login,
        ...
        route: isLoggedIn
            ...
            : () {
                //branchProvider.updateBranchId(-1, isUpdate: true);
