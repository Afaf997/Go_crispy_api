...
class RouterHelper {
  ...
  static String getotpRoute({RouteAction? action}) =>
      _navigateRoute(otpScreen, route: action);
  ...
  static String getotpScreen({RouteAction action = RouteAction.push}) =>
      _navigateRoute(otpScreen, route: action);
  ...
  static String _navigateToLogin(String path) {
    Get.context?.pushReplacement(path);
  ...
  static final goRoutes = GoRouter(
    ...
    routes: [
            ...
            return _routeHandler(
                ...
                (!fromCart
                    ...
                    : CheckoutScreen(
                        ...
                        vehicleNumber:
                            state.uri.queryParameters['vehicleNumber'],
                      )),
                isBranchCheck: true);
          }),
      ...
      GoRoute(
          ...
          builder: (context, state) {
            final isOtpParam = state.uri.queryParameters['isOtp'];
            final isOtp =
                isOtpParam != null ? isOtpParam.toLowerCase() == 'true' : false;
            return _routeHandler(
                context,
                BranchListScreen(
                  useNavigator: false,
